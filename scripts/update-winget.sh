...
SHA256=$(curl -sL "https://github.com/plongitudes/beads/releases/download/v$VERSION/checksums.txt" | grep windows | awk '{print $1}')

if [ -z "$SHA256" ]; then
    echo "Error: Could not find Windows checksum for v$VERSION"
    echo "Make sure the release exists: https://github.com/plongitudes/beads/releases/tag/v$VERSION"
    exit 1
fi
...
cat > "$WINGET_DIR/Plongitudes.beads.yaml" << EOF
# yaml-language-server: \$schema=https://aka.ms/winget-manifest.version.1.6.0.schema.json
PackageIdentifier: Plongitudes.beads
...
cat > "$WINGET_DIR/Plongitudes.beads.installer.yaml" << EOF
...
Installers:
  - Architecture: x64
    InstallerUrl: https://github.com/plongitudes/beads/releases/download/v$VERSION/beads_${VERSION}_windows_amd64.zip
...
cat > "$WINGET_DIR/Plongitudes.beads.locale.en-US.yaml" << EOF
# yaml-language-server: \$schema=https://aka.ms/winget-manifest.defaultLocale.1.6.0.schema.json
PackageIdentifier: Plongitudes.beads
PackageVersion: $VERSION
PackageLocale: en-US
Publisher: Beads Contributors
PublisherUrl: https://github.com/plongitudes
PublisherSupportUrl: https://github.com/plongitudes/beads/issues
Author: Beads Contributors
PackageName: beads
PackageUrl: https://github.com/plongitudes/beads
License: MIT
LicenseUrl: https://github.com/plongitudes/beads/blob/main/LICENSE
Copyright: Copyright (c) 2024 Beads Contributors
...
Tags:
  ...
  - cli
  - developer-tools
ReleaseNotesUrl: https://github.com/plongitudes/beads/releases/tag/v$VERSION
...
echo "3. Copy winget/*.yaml to manifests/s/Plongitudes/beads/$VERSION/"
