...
async function install() {
  try {
    ...
    // Format: https://github.com/plongitudes/beads/releases/download/v0.21.5/beads_0.21.5_darwin_amd64.tar.gz
    ...
    const downloadUrl = `https://github.com/plongitudes/beads/releases/download/v${releaseVersion}/${archiveName}`;
    ...
    console.error('1. Installing manually from: https://github.com/plongitudes/beads/releases');
    console.error('2. Using the install script: curl -fsSL https://raw.githubusercontent.com/plongitudes/beads/main/scripts/install.sh | bash');
    console.error('3. Opening an issue: https://github.com/plongitudes/beads/issues');
    process.exit(1);
  }
}
