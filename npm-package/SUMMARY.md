...
- Constructs URL: `https://github.com/plongitudes/beads/releases/download/v{VERSION}/beads_{VERSION}_{platform}_{arch}.{ext}`
...
- [beads repository](https://github.com/plongitudes/beads)
