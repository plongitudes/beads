...
# Via package manager
# See https://github.com/plongitudes/beads#installing
```
...
1. **Check existing issues:** https://github.com/plongitudes/beads/issues
...
- [beads GitHub](https://github.com/plongitudes/beads) - Official documentation
