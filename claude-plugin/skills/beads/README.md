...
A comprehensive skill for using [beads](https://github.com/plongitudes/beads) (bd) issue tracking with Claude Code.
...
- [bd CLI](https://github.com/plongitudes/beads) installed (`brew install plongitudes/beads/bd`)
...
This skill is maintained at [github.com/plongitudes/beads](https://github.com/plongitudes/beads) in the `claude-plugin/skills/beads/` directory.
