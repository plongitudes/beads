...
class BdNotFoundError(BdError):
    ...
    def installation_message(attempted_path: str) -> str:
        ...
        return (
            ...
            "Or visit: https://github.com/plongitudes/beads#installation\n\n"
...
class BdCliClient(BdClientBase):
    ...
    async def _check_version(self) -> None:
        ...
        if version < min_version:
            ...
            install_cmd = "curl -fsSL https://raw.githubusercontent.com/plongitudes/beads/main/scripts/install.sh | bash"
