...
MCP server for [beads](https://github.com/plongitudes/beads) issue tracker and agentic memory system.
...
### ~~MCP Tools Not Loading in Claude Code~~ (Issue [#346](https://github.com/plongitudes/beads/issues/346)) - RESOLVED
