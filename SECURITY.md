...
**Email**: security@plongitudes.com (or open a private security advisory on GitHub)
...
5. **Regular updates** - Keep bd updated to the latest version: `go install github.com/plongitudes/beads/cmd/bd@latest`
