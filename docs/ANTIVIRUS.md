...
1. Download beads from the [official GitHub releases](https://github.com/plongitudes/beads/releases)
...
4. Reference: beads is open-source CLI tool (https://github.com/plongitudes/beads)
...
Yes. Beads is:
- Open source (all code is auditable on [GitHub](https://github.com/plongitudes/beads))
...
1. Open an issue on [GitHub](https://github.com/plongitudes/beads/issues)
2. Include:
