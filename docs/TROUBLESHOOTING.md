...
```bash
# Check if installed
go list -f {{.Target}} github.com/plongitudes/beads/cmd/bd
...
CGO_ENABLED=1 go install github.com/plongitudes/beads/cmd/bd@latest

# Or if building from source
git clone https://github.com/plongitudes/beads
cd beads
CGO_ENABLED=1 go build -o bd ./cmd/bd
sudo mv bd /usr/local/bin/
```

If you installed via Homebrew, this shouldn't be necessary as the formula already enables CGO. If you're still seeing crashes with the Homebrew version, please [file an issue](https://github.com/plongitudes/beads/issues).
...
2. **Verify file integrity before excluding**:
   ...
   shasum -a 256 bd
   ```
   Compare with checksums from the [GitHub release page](https://github.com/plongitudes/beads/releases)
...
**Note:** The `--hard` and `--skip-init` flags mentioned in [GH#479](https://github.com/plongitudes/beads/issues/479) were never implemented. Use the workarounds above for a complete reset.

**Related:** [GH#922](https://github.com/plongitudes/beads/issues/922)
...
- GitHub issue [#353](https://github.com/plongitudes/beads/issues/353) for background
...
1. **Check existing issues**: [GitHub Issues](https://github.com/plongitudes/beads/issues)
...
3. **File a bug report**: Include:
   ...
   - Steps to reproduce
4. **Join discussions**: [GitHub Discussions](https://github.com/plongitudes/beads/discussions)
